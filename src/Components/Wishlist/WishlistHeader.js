...
function WishlistHeader() {
    return (
        <>
            <div className='bg_top_navigation row m-0' style={{ height: "61px", paddingTop: "17px", borderBottom: "1px solid #E6E6E6", position: "fixed", background: "white", zIndex: "1", width: "486px" }}>
